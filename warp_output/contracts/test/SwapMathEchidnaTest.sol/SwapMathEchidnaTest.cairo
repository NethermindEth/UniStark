...
namespace SwapMathEchidnaTest{
    ...
    func __warp_conditional_computeSwapStep_100d3f74_1(__warp_12_max : felt, __warp_10_exactIn : felt)-> (__warp_rc_0 : felt, __warp_12_max : felt, __warp_10_exactIn : felt){
    alloc_locals;
    ...
    func __warp_conditional_computeSwapStep_100d3f74_3(__warp_12_max : felt, __warp_10_exactIn : felt)-> (__warp_rc_2 : felt, __warp_12_max : felt, __warp_10_exactIn : felt){
    alloc_locals;
    ...
    func __warp_conditional_computeSwapStep_100d3f74_5(__warp_12_max : felt, __warp_10_exactIn : felt)-> (__warp_rc_4 : felt, __warp_12_max : felt, __warp_10_exactIn : felt){
    alloc_locals;
    ...
    func __warp_conditional_computeSwapStep_100d3f74_7(__warp_12_max : felt, __warp_10_exactIn : felt)-> (__warp_rc_6 : felt, __warp_12_max : felt, __warp_10_exactIn : felt){
    alloc_locals;
    ...
    func __warp_conditional_computeSwapStep_100d3f74_9{range_check_ptr : felt}(__warp_10_exactIn : felt, __warp_7_amountOut : Uint256, __warp_3_amountRemaining : Uint256)-> (__warp_rc_8 : felt, __warp_10_exactIn : felt, __warp_7_amountOut : Uint256, __warp_3_amountRemaining : Uint256){
    alloc_locals;
        ...
        if (1 - __warp_10_exactIn != 0){
            ...
            let (__warp_se_27) = warp_negate256(__warp_3_amountRemaining);
            
            let (__warp_se_28) = warp_gt256(__warp_7_amountOut, __warp_se_27);
    ...
    func __warp_conditional_computeSwapStep_100d3f74_11(__warp_10_exactIn : felt, __warp_5_sqrtRatioNextX96 : felt, __warp_1_sqrtRatioTargetX96 : felt)-> (__warp_rc_10 : felt, __warp_10_exactIn : felt, __warp_5_sqrtRatioNextX96 : felt, __warp_1_sqrtRatioTargetX96 : felt){
    alloc_locals;
        ...
        if (__warp_10_exactIn != 0){
            ...
            let (__warp_se_29) = warp_neq(__warp_5_sqrtRatioNextX96, __warp_1_sqrtRatioTargetX96);
        ...
        let __warp_6_amountIn = Uint256(low=0, high=0);
            ...
            let (__warp_10_exactIn) = warp_ge_signed256(__warp_3_amountRemaining, Uint256(low=0, high=0));
                ...
                if (__warp_10_exactIn != 0){
                    ...
                    let (__warp_se_30) = warp_sub_unsafe24(1000000, __warp_4_feePips);
                    
                    let (__warp_se_31) = warp_uint256(__warp_se_30);
                    
                    let (__warp_11_amountRemainingLessFee) = mulDiv_aa9a0912(__warp_3_amountRemaining, __warp_se_31, Uint256(low=1000000, high=0));
                    ...
                    let (__warp_se_34) = warp_ge256(__warp_se_33, __warp_7_amountOut);
                        ...
                        if (__warp_se_34 != 0){
                            ...
                            let (__warp_pse_5) = getNextSqrtPriceFromOutput_fedf2b5f(__warp_0_sqrtRatioCurrentX96, __warp_2_liquidity, __warp_se_35, __warp_9_zeroForOne);
            ...
            let (__warp_12_max) = warp_eq(__warp_1_sqrtRatioTargetX96, __warp_5_sqrtRatioNextX96);
                ...
                if (__warp_9_zeroForOne != 0){
                    ...
                    let __warp_rc_0 = 0;
                        ...
                        let (__warp_tv_0, __warp_tv_1, __warp_tv_2) = __warp_conditional_computeSwapStep_100d3f74_1(__warp_12_max, __warp_10_exactIn);
                    ...
                    let __warp_rc_2 = 0;
                        ...
                        let (__warp_tv_3, __warp_tv_4, __warp_tv_5) = __warp_conditional_computeSwapStep_100d3f74_3(__warp_12_max, __warp_10_exactIn);
                    ...
                    let __warp_rc_4 = 0;
                        ...
                        let (__warp_tv_6, __warp_tv_7, __warp_tv_8) = __warp_conditional_computeSwapStep_100d3f74_5(__warp_12_max, __warp_10_exactIn);
                    ...
                    let __warp_rc_6 = 0;
                        ...
                        let (__warp_tv_9, __warp_tv_10, __warp_tv_11) = __warp_conditional_computeSwapStep_100d3f74_7(__warp_12_max, __warp_10_exactIn);
            ...
            let __warp_rc_8 = 0;
                ...
                let (__warp_tv_12, __warp_tv_13, __warp_tv_14, __warp_tv_15) = __warp_conditional_computeSwapStep_100d3f74_9(__warp_10_exactIn, __warp_7_amountOut, __warp_3_amountRemaining);
                ...
                if (__warp_rc_8 != 0){
                    ...
                    let (__warp_se_36) = warp_negate256(__warp_3_amountRemaining);
                    
                    let __warp_7_amountOut = __warp_se_36;
                    tempvar range_check_ptr = range_check_ptr;
                    tempvar bitwise_ptr = bitwise_ptr;
                    tempvar __warp_8_feeAmount = __warp_8_feeAmount;
                    tempvar __warp_7_amountOut = __warp_7_amountOut;
            ...
            let __warp_rc_10 = 0;
                ...
                let (__warp_tv_16, __warp_tv_17, __warp_tv_18, __warp_tv_19) = __warp_conditional_computeSwapStep_100d3f74_11(__warp_10_exactIn, __warp_5_sqrtRatioNextX96, __warp_1_sqrtRatioTargetX96);
    ...
    alloc_locals;
        ...
        let (__warp_se_84) = warp_uint256(__warp_0_sqrtPX96);
        
        let (__warp_pse_17) = warp_mul256(__warp_2_amount, __warp_se_84);
        
        let __warp_8_product = __warp_pse_17;
        
        let (__warp_se_85) = warp_div256(__warp_pse_17, __warp_2_amount);
        
        let (__warp_se_86) = warp_uint256(__warp_0_sqrtPX96);
        ...
        if (__warp_se_87 != 0){
            ...
            let (__warp_se_88) = warp_gt256(__warp_5_numerator1, __warp_8_product);
    ...
    alloc_locals;
            ...
            let (__warp_se_89) = warp_eq256(__warp_2_amount, Uint256(low=0, high=0));
            ...
            if (__warp_3_add != 0){
                ...
                let (__warp_pse_13) = warp_mul_unsafe256(__warp_2_amount, __warp_se_91);
                
                let __warp_6_product = __warp_pse_13;
                
                let (__warp_se_92) = warp_div_unsafe256(__warp_pse_13, __warp_2_amount);
                    ...
                    if (__warp_se_94 != 0){
                        ...
                        let (__warp_se_95) = warp_ge256(__warp_7_denominator, __warp_5_numerator1);
                            ...
                            if (__warp_se_95 != 0){
                                ...
                                let (__warp_pse_14) = mulDivRoundingUp_0af8b27f(__warp_5_numerator1, __warp_se_96, __warp_7_denominator);
                ...
                let (__warp_se_99) = warp_div_unsafe256(__warp_5_numerator1, __warp_se_98);
                
                let (__warp_pse_15) = add_771602f7(__warp_se_99, __warp_2_amount);
                ...
                let (__warp_se_101) = warp_uint256(__warp_0_sqrtPX96);
                
                let (__warp_pse_18) = mulDivRoundingUp_0af8b27f(__warp_5_numerator1, __warp_se_101, __warp_9_denominator);
            ...
            if (__warp_13_add != 0){
                ...
                let (__warp_se_103) = warp_le256(__warp_12_amount, __warp_se_102);
                    ...
                    if (__warp_se_103 != 0){
                        ...
                        let (__warp_pse_20) = mulDiv_aa9a0912(__warp_12_amount, Uint256(low=79228162514264337593543950336, high=0), __warp_se_107);
                ...
                let (__warp_se_108) = warp_uint256(__warp_10_sqrtPX96);
                
                let (__warp_pse_21) = add_771602f7(__warp_se_108, __warp_15_quotient);
                ...
                let (__warp_se_110) = warp_le256(__warp_12_amount, __warp_se_109);
                
                    
                    if (__warp_se_110 != 0){
                    
                        
                        let (__warp_se_111) = warp_shl256(__warp_12_amount, 96);
                        ...
                        let (__warp_se_113) = warp_uint256(__warp_11_liquidity);
                        
                        let (__warp_pse_24) = mulDivRoundingUp_0af8b27f(__warp_12_amount, Uint256(low=79228162514264337593543950336, high=0), __warp_se_113);
                ...
                let (__warp_se_114) = warp_uint256(__warp_10_sqrtPX96);
                
                let (__warp_se_115) = warp_gt256(__warp_se_114, __warp_16_quotient);
                
                assert __warp_se_115 = 1;
                
                let (__warp_se_116) = warp_uint256(__warp_10_sqrtPX96);
                
                let (__warp_se_117) = warp_sub_unsafe256(__warp_se_116, __warp_16_quotient);
    ...
    alloc_locals;
            ...
            if (__warp_28_roundUp != 0){
                ...
                let (__warp_pse_29) = mulDivRoundingUp_0af8b27f(__warp_29_numerator1, __warp_30_numerator2, __warp_se_127);
                ...
                let (__warp_pse_31) = mulDiv_aa9a0912(__warp_29_numerator1, __warp_30_numerator2, __warp_se_129);
    ...
    alloc_locals;
        ...
        let __warp_2_z = Uint256(low=0, high=0);
            ...
            let (__warp_se_143) = warp_ge256(__warp_pse_42, __warp_0_x);
    ...
    alloc_locals;
        ...
        let (__warp_se_6) = warp_lt_signed256(__warp_3_amountRemaining, Uint256(low=0, high=0));
            ...
            if (__warp_se_6 != 0){
                ...
                tempvar bitwise_ptr = bitwise_ptr;
                tempvar __warp_5_sqrtQ = __warp_5_sqrtQ;
                tempvar __warp_1_sqrtPriceTargetRaw = __warp_1_sqrtPriceTargetRaw;
                tempvar __warp_0_sqrtPriceRaw = __warp_0_sqrtPriceRaw;
                tempvar __warp_3_amountRemaining = __warp_3_amountRemaining;
                tempvar __warp_6_amountIn = __warp_6_amountIn;
                tempvar __warp_8_feeAmount = __warp_8_feeAmount;
                tempvar __warp_7_amountOut = __warp_7_amountOut;
